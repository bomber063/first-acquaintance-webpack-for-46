!function () {
  ...
  var controller = {
    view: null,
    //经过第二步这里的view就是外面的view啦
    swiper: null,
    //经过第四步后swiper被new Swiper(this.view.querySelector('.swiper-container'), this.swiperOptions)赋值
    swiperOptions: {
      ...
      scrollbar: {// el: '.swiper-scrollbar',//是否需要滚动条
      }
    },
    init: function (x) {
...
let numbers = [1, 2, 3];
let dou = numbers.map(function (number) {
  return number * 2;
});
console.log(dou);