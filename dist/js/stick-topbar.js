!function () {
  ...
  var controller = {
    ...
    bindEvents: function () {
      ...
      window.addEventListener('scroll', function () {
        if (window.scrollY > 0) {
          ...
          _this.active(); //active是函数，所以要后面加上()
          // console.log('滑动',this)
        ...
        if (window.scrollY <= 0) {
          ...
          _this.deactive(); //deactive是函数，所以要后面加上()
    ...
    active: function () {
      this.view.classList.add('sticky'); // console.log('active',this)
    },
    deactive: function () {
      this.view.classList.remove('sticky'); // console.log('deactive',this)
    }
  };
